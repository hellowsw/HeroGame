...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UnityDLL.AccountServer.OnConnectedHandler), UnityDLL_AccountServer_OnConnectedHandler);
	...
	class UnityDLL_AccountServer_OnConnectedHandler_Event : LuaDelegate
	{
		public UnityDLL_AccountServer_OnConnectedHandler_Event(LuaFunction func) : base(func) { }
		public UnityDLL_AccountServer_OnConnectedHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate UnityDLL_AccountServer_OnConnectedHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UnityDLL.AccountServer.OnConnectedHandler fn = delegate() { };
			return fn;
		}

		if(!flag)
		{
			UnityDLL_AccountServer_OnConnectedHandler_Event target = new UnityDLL_AccountServer_OnConnectedHandler_Event(func);
			UnityDLL.AccountServer.OnConnectedHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UnityDLL_AccountServer_OnConnectedHandler_Event target = new UnityDLL_AccountServer_OnConnectedHandler_Event(func, self);
			UnityDLL.AccountServer.OnConnectedHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
