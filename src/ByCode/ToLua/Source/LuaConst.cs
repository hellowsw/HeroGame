...
public static class LuaConst
{
    ...
    public static string luaDir
    {
        get {
            ...
            path = path.Substring(0, path.LastIndexOf('/') + 1) + "src/LuaScripts/Lua/";
            return path;
        }
    }
    ...
    public static string toluaDir
    {
        get {
            string path = Application.dataPath.Replace(@"\", "/").Replace("/Assets", "");
            path = path.Substring(0, path.LastIndexOf('/') + 1) + "src/LuaScripts/ToLua/Lua/";
            return path;
        }       
    }  
    ...
    {
        get {
            return Application.dataPath.Replace(@"\", "/") + "/PlatformLua/";
        }
    }
